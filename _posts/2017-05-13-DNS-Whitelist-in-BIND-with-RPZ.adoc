...
Unfortunately there have been numerous security and privacy issues with smart TVs of all kinds, and Samsung in http://www.bbc.com/news/technology-31296188[particular].  So being predictably paranoid I therefore blocked the TV's IP address on my router to stop it getting to the internet.
