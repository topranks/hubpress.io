...
Unfortunately there have been numerous security and privacy issues with smart TVs of all kinds, and Samsung in http://www.bbc.com/news/technology-31296188[particular].  Being predictably paranoid I immediately blocked the TV's IP address on my router to stop it getting to the internet.

As it turns out however, the built-in Netflix app on the TV is my only option for 4k Netflix (my HTPC won't work due to not having a Kaby Lake chip despite having an Nvidia Pascal card....).

Anyway, I found myself in a situation where I needed to allow the TV get out to the internet, despite my misgivings.
